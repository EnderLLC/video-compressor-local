import AudioRemover from "@/components/features/audio-remover";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";

export const metadata = {
  title: "Remove Audio from Video - Online & Free",
  description: "Strip audio track from any video file instantly, completely privately. Your files never leave your browser.",
};
      ...
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        <div className="text-center mb-10">
          ...
          <p className="mt-4 text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Delete the audio track from your videos securely, right in your browser. No uploads, no privacy risks.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="lg:w-2/3">
            <Card className="border shadow-lg">
              <CardHeader>
                ...
                <CardDescription>
                  Upload a video file (MP4, MOV, AVI, etc.) and remove its audio track completely. Processing happens locally via WebAssembly.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <AudioRemover />
            ...
            <div className="mt-8">
              ...
              <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                ...
                <li className="flex items-start">
                  ...
                  <span><strong>Click Remove Audio</strong> – The tool will load FFmpeg (once) and strip the audio track using stream copy. No re‑encoding, instant result.</span>
                </li>
                <li className="flex items-start">
                  <span className="inline-block w-6 h-6 bg-indigo-500 text-white rounded-full text-center mr-3 flex-shrink-0">3</span>
                  <span><strong>Download muted video</strong> – Get a video file with the same video quality but no audio.</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="lg:w-1/3">
            <Card className="border shadow">
              <CardHeader>
                <CardTitle>Why Use Local Audio Remover</CardTitle>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                  ...
                  <p className="text-sm text-purple-700 dark:text-purple-400 mt-1">
                    Remove audio from 1GB, 5GB or even 10GB videos. No artificial limits because everything runs on your hardware.
                  </p>
                </div>
                <div className="p-4 bg-amber-50 dark:bg-amber-900/20 rounded-lg">
                  <h3 className="font-semibold text-amber-800 dark:text-amber-300">Wide Format Support</h3>
                  <p className="text-sm text-amber-700 dark:text-amber-400 mt-1">
                    Works with MP4, MOV, AVI, MKV, and more. Output is a standard MP4 with video track only.
                  </p>
                </div>
              </CardContent>
            </Card>
