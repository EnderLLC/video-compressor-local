...
import { useAudioMerger } from "@/hooks/use-audio-merger";
...
export default function AudioMerger() {
  ...
  const onDrop = useCallback((acceptedFiles: File[]) => {
    // Filter out non-audio files maybe
  ...
  const handleDownload = () => {
    ...
    a.href = outputUrl;
    a.download = files.length === 1 ? `merged-${files[0].name}` : "merged-audio.mp3";
      ...
      {files.length === 0 ? (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-2">
                  or click to browse (MP3, WAV, AAC, etc.)
                </p>
                <p className="text-xs text-gray-400 mt-2">
                  Select at least two audio files to merge
                </p>
              </div>
            </div>
          </div>
        ...
        <Card className="w-full">
          <CardHeader>
            ...
            <CardDescription>
              Reorder the audio files (top to bottom) and click Merge to join them into a single file.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              <Button
                ...
                className="min-w-32"
              >
                {isProcessing ? "Merging..." : loading ? "Loading FFmpeg..." : "Merge Audio"}
              </Button>
              {loaded && !isProcessing && (
            ...
            {outputUrl && (
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                ...
                <p className="text-sm text-green-700 mb-4">
                  Your audio files have been merged and are ready to download.
                </p>
